...
#include "ESP32PWM.h"
const byte VL53LOX_InterruptPin = 5;
...
void setup() {
	...
	myservo.setTimerWidth(50);    // standard 50 hz servo
  ...
  FixPoint1616_t LowThreashHold = (600 * 65536.0);
  FixPoint1616_t HighThreashHold = (1200 * 65536.0);
